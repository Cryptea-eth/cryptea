...
const DashHome = () => {
  const { isAuthenticated, account, chainId } = useCryptea();
  ...
  const [rprevious, rcurrent] = false
    ? [received[received.length - 2].amt, received[received.length - 1].amt]
    : [0, 0];
  ...
  const columns: {
    ...
    minWidth: number;
    align?: "right" | "left";
    format?: <Val extends string & number>(value: Val) => string | number;
  }[] = [
      ...
      name: (
        <div className="flex items-center">
          ...
          <IconButton
            ...
            onClick={() => {
              viewN(!nft);
              const { clientWidth = 0 }: { clientWidth?: number } =
          ...
          <div className="min-w-[337px] 2sm:hidden pt-5 h-full">
            <div className="px-4 pt-3 bg-white border-[1px] border-solid border-[#e3e3e3] rounded-[4px]">
              ...
              {Boolean(links.length) && !loading2 && (
                <div className="py-2">
                  {links.map(
                    ({ template_data, link, desc }: any, i: number) => {
                      let source = "";
                          ...
                          <div className="border-b-[#f57059] border-b flex justify-between py-2">
                            <div className="flex">
                              ...
                              <div className="pl-2 flex flex-col">
                                ...
                                <div className="font-nomal text-[10px]">
                                  {desc ? desc : ""}
                                </div>
                              </div>
                            </div>
